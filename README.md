...
If I had more time I would add an additional agent to scan various sites for trending topics and use that research to inform my blog topics. This would require integrating applicable MCP servers or building custom tools.### Problem Statement -- the problem you're trying to solve, and why you think it's an important or interesting problem to solve
